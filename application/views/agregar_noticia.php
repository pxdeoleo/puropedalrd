			...
			<div class="container col-8">
				...
				<div class="form-group">
					<div class='input-group'>
						<?=asgInput('asunto', 'Asunto', ['required'=>'required', 'value'=> $asunto])?>
					</div>
					<br>
					<div class="input-group">
						<div class="input-group-prepend">
							...
							<div class="custom-file">
								<input type="file" <?php if(!isset($id_noticia)){echo('required');} ?> name="foto" class="custom-file-input" id="inputGroupFile01">
								<label class="custom-file-label" for="inputGroupFile01"><?=$foto?></label>
							</div>
						</div>  
					</div>
					<label for="full-featured">Contenido</label>
					<textarea name='contenido' style="height:200px" id="full-featured"><?=$contenido?></textarea>
